...
from agent_server.app.agent.deep_research.prompt.prompts_zh import lead_researcher_prompt
from agent_server.app.agent.deep_research.research_agent import researcher_agent
from agent_server.app.agent.deep_research.state.state_multi_agent_supervisor import SupervisorState
from agent_server.app.agent.deep_research.research_tool import (
    think_tool,
    ConductResearch,
    ResearchComplete
)
...
logger = build_logger("multi-agent-supervisor")
...
supervisor_model = ModelFactory.get_model("deepseek", "deepseek-chat")
...
path = os.path.join(Settings.basic_settings.TEMP_IMAGE_PATH, "supervisor_agent.png")
