...
from agent_server.app.agent.deep_research.research_schema import ResearchQuestion, ClarifyWithUser
...
model = ModelFactory.get_model(model_name="deepseek-chat")
...
path = os.path.join(Settings.basic_settings.TEMP_IMAGE_PATH, "research_scope_agent.png")
